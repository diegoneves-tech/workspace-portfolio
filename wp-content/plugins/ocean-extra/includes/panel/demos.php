				...
				if ( ! is_wp_error( $api ) ) { // confirm error free
					...
					<div class="owp-plugin owp-clr owp-plugin-<?php echo $api['slug']; ?>" data-slug="<?php echo $api['slug']; ?>" data-init="<?php echo $api['init']; ?>">
						...
						if ( 'premium' == $return
							...
							<a class="button" href="httpss://oceanwp.org/extension/<?php echo $api['slug']; ?>/" target="_blank"><?php esc_html_e( 'Get This Addon', 'ocean-extra' ); ?></a>
						<?php
						} else { ?>
