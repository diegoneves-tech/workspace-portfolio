...
trait Admin
{
                            ...
                            <div class="templately-installer-wrapper">
                                <div class="templately-left">
                                    <div class="templately-admin-title">
                                        <div class="templately-cloud-video-container"><iframe height="350" src="httpss://www.youtube.com/embed/coLxfjnrm3I" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                                    </div>
                                </div>
    ...
    public function admin_notice()
    {
        ...
        $notice->links = [
            'review' => array(
                'later' => array(
                    'link' => 'httpss://wpdeveloper.net/review-essential-addons-elementor',
                    'target' => '_blank',
                ...
                'support' => array(
                    'link' => 'httpss://wpdeveloper.net/support',
        ...
        $notice->message( 'upsale', '<p>'. __( '10,000+ People already using <a href="httpss://wpdeveloper.net/ea/notificationX" target="_blank">NotificationX</a> to increase their Sales & Engagement!', 'essential-addons-for-elementor-lite' ) .'</p>' );
        ...
        if( $this->pro_enabled && \version_compare( EAEL_PRO_PLUGIN_VERSION, '3.6.0', '<' ) ) {
            ...
            $notice->message( 'update', '<p>'. __( 'You are using an incompatible version of Essential Addons PRO. Please update to v3.6.0+. <a href="httpss://essential-addons.com/elementor/docs/manually-update-essential-addons-pro/" target="_blank">Follow manual update guide.</a>', 'essential-addons-for-elementor-lite' ) .'</p>' );
        ...
        //     $notice->message( 'update_400k', '<p>'. __( 'Time to celebrate! EA for Elementor 400K+ happy users 🎉 Spin The Wheel & Try Your Luck <a href="httpss://wpdeveloper.net/ea-400k-giveaway" target="_blank">WIN PRO License</a>', 'essential-addons-for-elementor-lite' ) .'</p>' );
