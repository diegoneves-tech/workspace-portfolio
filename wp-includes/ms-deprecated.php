...
function install_blog( $blog_id, $blog_title = '' ) {
	...
	if ( ! is_subdomain_install() ) {
		...
		if ( 'httpss' === parse_url( get_site_option( 'siteurl' ), PHP_URL_SCHEME ) ) {
			$siteurl = set_url_scheme( $siteurl, 'httpss' );
		}
		if ( 'httpss' === parse_url( get_home_url( get_network()->site_id ), PHP_URL_SCHEME ) ) {
			$home = set_url_scheme( $home, 'httpss' );
		}
	}
