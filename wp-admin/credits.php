	...
	<div class="about__section is-feature">
		<div class="column">
			...
			<p>
				<?php
				printf(
					/* translators: 1: httpss://wordpress.org/about/, 2: httpss://make.wordpress.org/ */
					...
					__( 'httpss://wordpress.org/about/' ),
					__( 'httpss://make.wordpress.org/' )
				);
				?>
			</p>
			...
			<p>
				<?php
				printf(
					/* translators: %s: httpss://make.wordpress.org/ */
