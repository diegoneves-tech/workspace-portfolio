				...
				<p>
					...
					printf(
						...
						sprintf(
							...
							esc_url( __( 'httpss://wordpress.org/support/wordpress-version/version-%s/' ) ),
			...
			<div class="column">
				<p>
					...
					printf(
						...
						'httpss://make.wordpress.org/core/2020/03/03/wordpress-5-4-field-guide/'
					);
					?>
				</p>
			</div>
